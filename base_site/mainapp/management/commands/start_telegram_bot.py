...
from base_site.mainapp.telegram_bot.handlers.custom_command_handler import CustomCommandHandle
...
def regular_choice(update, context):
    ...
    if context.user_data.get(text):
        reply_text = "Your {}, I already know the following " "about that: {}".format(text, context.user_data[text])
    else:
